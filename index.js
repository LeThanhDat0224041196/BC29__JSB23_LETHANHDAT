...
document.getElementById("tbTienluong").onclick = function(){
    var nhapNgaylam = document.getElementById("nhapNgaylam").value;
    var luong1ngay = document.getElementById("luong1Ngay").value;

    var tienluong = ("Lương của nhân viên: ")+(nhapNgaylam * luong1ngay);
    document.getElementById("thongBao").innerHTML = tienluong;
}
...
document.getElementById("giatriTBsothuc").onclick = function(){
    ...
    var giatriTBsothuc =("Giá trị trung bình của 5 số thực: ")+((soThuc1+soThuc2+soThuc3+soThuc4+soThuc5)/5);
    document.getElementById("giatriTB").innerHTML = giatriTBsothuc;
...
document.getElementById("tinhquydoiVND").onclick = function(){
    var nguoidungnhapUSD = document.getElementById("nhapUSD").value;
    var usdquydoiVND = document.getElementById("vndtoUSD").value;

    var tienquydoiVND = ("TIền quy đổi: ") + (nguoidungnhapUSD*usdquydoiVND);

    document.getElementById("tienquydoiVND").innerHTML=tienquydoiVND;
}
...
document.getElementById("tong2kyso").onclick = function(){
    ...
    var hang_don_vi = Math.floor(soThu1%10);
    var hang_chuc = Math.floor(soThu1/10);
    var tong =("Tổng 2 ký số: ") + (hang_chuc + hang_don_vi);

    document.getElementById("tbSo").innerHTML = tong;
